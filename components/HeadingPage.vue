<template>
  <div class="headingContainer">
    ...
    <div v-if="this.role==='COACH'">
      <ButtonHeading @setStatus="updateStatus()" @sendRequest="save()" v-if="this.status==='Edit' || this.status==='Done' || this.status==='Save' || this.status==='Assign' || this.status==='Change' || this.status==='Back'" active :message="this.status"/>
